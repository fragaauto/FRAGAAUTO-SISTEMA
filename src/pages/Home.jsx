...
const AGENTE_LAVA_JATO = 'atendimento_lavajato';
...
export default function Home() {
  ...
  const podeVerBotNovoAtendimento = isAdminUser || (user?.pode_ver_bot_novo_atendimento !== undefined ? user.pode_ver_bot_novo_atendimento : funcaoUsuario?.pode_ver_bot_novo_atendimento !== false);
  const podeVerBotAtendimentos = isAdminUser || (user?.pode_ver_bot_atendimentos !== undefined ? user.pode_ver_bot_atendimentos : funcaoUsuario?.pode_ver_bot_atendimentos !== false);
  const podeVerBotAssistenteWhats = isAdminUser || (user?.pode_ver_bot_assistente_whatsapp !== undefined ? user.pode_ver_bot_assistente_whatsapp : funcaoUsuario?.pode_ver_bot_assistente_whatsapp !== false);
          ...
          <motion.div
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-4 mt-8">
                ...
                {podeVerBotAssistenteWhats &&
                <a href={base44.agents.getWhatsAppConnectURL(agenteName)} target="_blank" rel="noopener noreferrer">
                  <Button size="lg" className="bg-green-500 hover:bg-green-600 text-white h-12 px-6 text-base">
            ...
            <motion.div
              ...
              <div className="relative">
                ...
                <div className="relative backdrop-blur-sm rounded-3xl p-8 border border-white/20 bg-[#2a1e58]">
                  ...
                  <Car className="w-48 h-48 text-orange-400" />
                  }
                </div>
              </div>
            </motion.div>
