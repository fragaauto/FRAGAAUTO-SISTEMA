...
const FunctionDisplay = ({ toolCall }) => {
  ...
  const statusConfig = {
    ...
    running: { icon: Loader2, color: 'text-purple-500', text: 'Executando...', spin: true },
    in_progress: { icon: Loader2, color: 'text-purple-500', text: 'Executando...', spin: true },
    completed: isError
      ...
      <div className={cn("max-w-[85%]", isUser && "flex flex-col items-end")}>
        {message.content && (
          <div className={cn(
            ...
            isUser ? "bg-purple-600 text-white" : "bg-white border border-slate-200"
          )}>
            {isUser ? (
